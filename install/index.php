    ...
    if ($config_file && $node_file) {
        ...
        if ($query) {
          ...
          $con1 = mysqli_connect($_POST['sql_host'], $_POST['sql_user'], $_POST['sql_pass'], $_POST['sql_name']);
           ...
           $success = 'successfully installed, please wait ..';
        } else {
          $ServerErrors[] = "Error found while installing, please contact us.";
        }
      }
          ...
          <div class="wo_install_wiz">
            <div>
                            ...
                            <div class="setting-well">
                                <?php if ($page == 'terms') { ?>
                                <div class="terms">
                                    <h5>Welcome to the Facebook Source Code</h5>
                                    <br>
                                    <b class="bold">This is the Facebook Source code made open source by the Megalo Global Corporaton and released free to the public. We are Facebooks Biggest Competitor. </b><br>
                                    <br><br>100% OPEN SOURCE AND FREE
                                    <hr>
                                    <form action="?page=req" method="post">
                    <div class="wo_terms">
                      <input type="checkbox" name="agree" id="agree">
                      <label for="agree"> I am ready to install</label>
                    </div>
                    <br><br>
                  ...
                  <table class="table table-hover">
                    ...
                    <div class="setting-saved-update-alert milinglist"></div>
                                ...
                                <div class="req">
                                    <p>Congratulations! You have officially installed the Facebook source ocde.</p>
                  <p>Login to your admin panel to make changes and modify any default content according to your needs.</p>
                  <br>
                  <p>If you have any question, please <a href="mailto:developers@megaloglobal.com" class="main">let us know</a>.</p>
                                    <br><br>
                  ...
                  <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="purshase_code" value="<?php echo (!empty($_POST['purshase_code'])) ? trim($_POST['purshase_code']) : '';?>" placeholder="INSTALL CODE" autofocus>
                                                <span class="help-block">Licensed By <a href="https://facebook.com" class="main">Meta Platforms Inc</a>.</span>
                                            </div>
                      <div class="col-md-2"></div>
                                        </div>
                                        <div class="form-group">
